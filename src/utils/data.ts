export const routes = [
  ...
  },
  {
    ...
    name: 'Line',
    image:
      'https://run-tracker-bucket.s3.amazonaws.com/CpAq9BwftlMHCLdLngZZDPEghyM2/f9fb1120-b70d-11ea-bf12-c17473385e35.png',
    start_point: [-117.740249, 34.107148, 362.65],
    end_point: [-117.717497, 34.10678, 391.71],
    lines: [
      [
        [-117.740249, 34.107148, 362.65],
        [-117.737908, 34.107104, 365.44],
        [-117.737687, 34.107065, 365.59],
        [-117.735545, 34.107029, 369.67],
        [-117.735547, 34.106959, 369.42],
      ...
      [
        ...
        [-117.726094, 34.106532, 383.03],
        [-117.725828, 34.106463, 383.09],
        [-117.725447, 34.106233, 383.32],
        [-117.724522, 34.105588, 381.89],
        [-117.724206, 34.105461, 382.18],
        [-117.723857, 34.105361, 382.23],
        [-117.723645, 34.10532, 382.28],
        [-117.720924, 34.105291, 382.72],
        [-117.720372, 34.105307, 383.78],
        [-117.72026, 34.105342, 384.61],
        [-117.720123, 34.105384, 385.61],
        [-117.718443, 34.105384, 387.05],
    ...
    city: 'Pomona',
    state: 'California',
    created_at: '2020-06-25T18:02:05.046Z',
    distance: '2423.9210000000003',
  },
  {
    id: 56,
    user_id: 'CpAq9BwftlMHCLdLngZZDPEghyM2',
    name: 'new line',
    image:
      'https://run-tracker-bucket.s3.us-west-1.amazonaws.com/CpAq9BwftlMHCLdLngZZDPEghyM2/07f826f0-b70e-11ea-bf12-c17473385e35.png',
    start_point: [-117.740249, 34.107148, 362.65],
    end_point: [-117.717497, 34.10678, 391.71],
    lines: [
      [
    ...
    city: 'Pomona',
    state: 'California',
    created_at: '2020-06-25T18:02:28.289Z',
    distance: '2423.9210000000003',
  },
];
